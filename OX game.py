...
lblTitle = Label(Tops, font=('arial', 50, 'bold'), text=" Tic Tac Toe By Muni Balaji", bd=21, fg='dodgerblue', bg='mistyrose',
                 justify=CENTER)
...
def scorekeeper():
    ...
    if (button1["text"] == "X" and button2["text"] == "X" and button3["text"] == "X"):
        ...
        tkinter.messagebox.showinfo("Tic Tac Toe By Muni Balaji", pa)
        reset()
    ...
    if (button1["text"] == "O" and button2["text"] == "O" and button3["text"] == "O"):
        ...
        tkinter.messagebox.showinfo(" Tic Tac Toe By Muni Balaji", pb)
        reset()
